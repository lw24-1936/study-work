...
本仓库是一套面向 **Java 后端**、**前端**、**算法工程师** 三个方向的技术学习笔记。知识按体系化篇章组织，每个主题一篇独立文档；文档间以 `[[filename]]` 交叉引用，形成可增量更新、可交叉检索的知识网络。
...
合计 **785 篇**学习文档（[index.md](./index.md) 注册 787 条索引，其中 2 条为知识库入口链接）。
