...
> 基于 Java 全栈学习知识体系编排，目前已覆盖前置章节 + 第一篇到第五十篇，共 223 篇。
...
- [[195-综合项目实战]] — 29 个项目进阶路线：前 9 个进阶项目（学生成绩管理系统 Java SE、用户管理系统 Servlet/JDBC、企业员工管理系统 Spring Boot/Redis、企业管理平台 RBAC/JWT/Vue、订单系统 RabbitMQ、微服务电商 Spring Cloud/Nacos/Feign、秒杀系统 Redis/MQ、数据平台 ES/Kafka、AI 应用 Spring AI/RAG/Agent/MCP），后 10 个独立落地项目（196-205）
